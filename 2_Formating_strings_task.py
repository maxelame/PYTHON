...
Напишите программу для формирования строки счета на оплату. Программа должна принимать из аргументов командной строки 3 параметра: наименование товара, количество и цену, а после выводить строку следующего вида: | <наименование> | <количество> | <цена> | <сумма> |.
