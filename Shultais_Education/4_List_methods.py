...
Ниже в редакторе содержится список cars с автомобилями. Напишите программу, которая принимает из аргументов командной строки два параметра: марку и модель автомобиля, а затем выводит True если автомобиль есть в списке и False в противном случае.
Пример использования:
...
Ниже содержится список с оценками. Напишите программу, которая принимает из первого аргумента оценку, а затем выводит количество, сколько раз эта оценка встречается в списке school_marks.
Пример использования:
> python program.py 2
> 2
 '''
...
Ниже содержится список с оценками. Напишите программу, которая принимает из первого аргумента оценку, а затем выводит процент встречаемости этой оценки в списке school_marks.

Например, если взять двойку, то она встречается в списке два раза, что составляет 11.8% от общего числа оценок. Обратите внимание, что результат нужно выводить с одним знаком после десятичной точки с символом процента в конце.
Пример использования:
> python program.py 2
> 11.8%'''
